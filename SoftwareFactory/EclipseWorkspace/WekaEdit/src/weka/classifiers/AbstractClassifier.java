 ...
 */
public abstract class AbstractClassifier implements Classifier, BatchPredictor, Cloneable, Serializable, OptionHandler,
	...
	public Enumeration<Option> listOptions() {
		...
		newVector.addElement(new Option("\tThe number of decimal places for the output of numbers in the model"
				+ " (default " + m_numDecimalPlaces + ").", "num-decimal-places", 1, "-num-decimal-places"));
		newVector.addElement(
				new Option("\tThe desired batch size for batch prediction " + " (default " + m_BatchSize + ").",
	 ...
	 * efficient manner. Default implementation here returns false. Subclasses
	 * to override as appropriate.
	 * 
	 * @return true if this classifier can generate batch predictions in an
	 *         efficient manner.
	 */
	 ...
	 * distributionForInstance() for each instance in the batch. If subclasses
	 * can produce batch predictions in a more efficient manner than this they
	 * should override this method and also return true from
	 * implementsMoreEfficientBatchPrediction()
	 * 
	 * @param batch
	 *            the instances to get predictions for
	 * @return an array of probability distributions, one for each instance in
	 *         the batch
	 * @throws Exception
	 *             if a problem occurs.
	 */
	 ...
	 * @param options
	 *            any options to pass to the object
	 * @throws Exception
